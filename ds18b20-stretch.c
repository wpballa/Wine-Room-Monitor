// version for Debian Stretch
// Bill Ballard 9-27-17

// sudo nano /boot/config.txt to add though you can also set this
// via raspi-config by selecting one-wire protocol
// dtoverlay=w1-gpio
// also sudo apt-get install ssmtp heirloom-mailx wiringpi
// if you are using stretch lite
